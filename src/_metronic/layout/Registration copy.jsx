...
import {Container, Modal, Nav, Navbar} from 'react-bootstrap-v5'
    ...
    <div>
      ...
      >
        ...
        <div className='fv-row mb-5'>
          <label className='class="form-label required fw-bolder text-dark fs-6'>Họ và tên</label>
          <input
        ...
        <div className='fv-row mb-5'>
          <label className='fs-6 fw-bold text-gray-600'>
            Tài khoản được tạo sẽ sử dụng số điện thoại đăng ký làm ID đăng nhập
          </label>
