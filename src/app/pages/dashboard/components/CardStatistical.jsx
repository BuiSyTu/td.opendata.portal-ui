...
const CardStatistical = () => {
    ...
    return (
        <>
        <div className="section-statistical" style={{backgroundImage: `url(${toAbsoluteUrl('media/images/bg-analytics.png')})`}}>
          <div className="container">
            <h4 className="title fs-1 fw-bold"><img src={toAbsoluteUrl('media/images/analytics.png')} className="h-40px me-3" alt="" />Thống kê</h4>
            <div className="row">
                    ...
                    { dataGroup.map( (i, index) => (
                      <div className="row align-items-center mb-2" key={index}>
                        <div className="col-xl-5 col-xxl-4">
                          <span className="text-gray-800 d-block fs-6 text-xl-end item-group-name">{i.name}</span>
                        </div>
                        <div className="col-xl-7 col-xxl-8 d-flex align-items-center">
                          <div className="progress h-15px w-100 me-2 bg-secondary" style={{borderRadius: '4px'}}>
                            <div className="progress-bar bg-danger" role="progressbar" style={{width: (i.count/maxValueOfQuaHan)*100 + '%'}} aria-valuenow={i.count} aria-valuemin="0" aria-valuemax={maxValueOfQuaHan}></div>
                          </div>
